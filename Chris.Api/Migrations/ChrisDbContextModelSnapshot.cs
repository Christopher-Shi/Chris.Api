...
{
    [DbContext(typeof(ChrisDbContext))]
    partial class ChrisDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chris.Api.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Chris.Api.Entities.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Chris.Api.Entities.Employee", b =>
                {
                    b.HasOne("Chris.Api.Entities.Company", "Company")
                        .WithMany("Employees")
